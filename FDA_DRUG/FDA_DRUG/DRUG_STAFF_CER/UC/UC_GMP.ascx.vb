Public Class UC_GMP
    ...
    Sub Set_Label()
        ...
        Try
            ...
            ElseIf Trim(dao.fields.DEPARTMENT_REGIST_CER_TYPE) = "2" Then
                cb_DEPARTMENT_REGIST_CER_TYPE2.Checked = True
                lbl_DEPARTMENT_REGIST_CER_NAME2.Text = dao.fields.DEPARTMENT_REGIST_CER_NAME
            End If
        Catch ex As Exception

        End Try
        Try
            rdl_gmp.SelectedValue = dao_mf.fields.STANDARD_ID
        Catch ex As Exception

        End Try
        Try
            Dim dao_iso As New DAO_DRUG.clsDBsysisocnt
            dao_iso.GetDataby_IDA(Trim(dao_mf.fields.COUNTRY_GMP))
            lbl_iso_gmp.Text = dao_iso.fields.engcntnm
        Catch ex As Exception
    ...
    Protected Sub cb_DEPARTMENT_REGIST_CER_TYPE2_CheckedChanged(sender As Object, e As EventArgs)
