Public Class CLS_DALCN_LOCATION
...
#Region "DB"
    ...
    Private _NCT_LCTADDRs As New DALCN_LOCATION_ADDRESS
    Public Property NCT_LCTADDRs() As DALCN_LOCATION_ADDRESS
        Get
    ...
    Private _LOCATION_BSNs As New List(Of DALCN_LOCATION_BSN)
    Public Property LOCATION_BSNs() As List(Of DALCN_LOCATION_BSN)
        Get
