<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_CER_FOREIGN_MAIN.aspx.vb" Inherits="FDA_DRUG.FRM_STAFF_CER_FOREIGN_MAIN" %>
...
<%--    <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2> GMP&nbsp; สถานที่ผลิตต่างประเทศ</h2>
     ...
     <div class="panel" style="text-align:left ;width:100%">
         <div class="panel-heading panel-title" style="height:70px" > 
             ...
             <div  class="col-lg-4 col-md-4"><h4>GMP  สถานที่ผลิตต่างประเทศ</h4> </div>
       ...
       <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="true" PageSize="15">
           <MasterTableView AutoGenerateColumns="False">
               <Columns>
                   ...
                   <telerik:GridBoundColumn DataField="CER_NUMBER" FilterControlAltText="Filter TR_ID column"
