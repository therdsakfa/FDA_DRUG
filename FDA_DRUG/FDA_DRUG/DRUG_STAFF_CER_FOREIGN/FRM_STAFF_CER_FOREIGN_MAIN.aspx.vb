...
Public Class FRM_STAFF_CER_FOREIGN_MAIN
    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "sel" Then
                ...
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "FRM_STAFF_CER_FOREIGN_CONFIRM.aspx?IDA=" & IDA & "&TR_ID=" & tr_id & "');", True)
            End If
