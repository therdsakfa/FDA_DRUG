...
Public Class WebForm14
    ...
    Protected Sub btn_confirm_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        ...
        Dim cernumber As String = bao.GEN_CER_NO(con_year(Date.Now.Year.ToString()), _CLS.PVCODE(), "", _CLS.LCNNO, "1", "1", _IDA, "")
        Dim rcvno As String = bao.GEN_CER_NO(con_year(Date.Now.Year.ToString()), _CLS.PVCODE(), "", _CLS.LCNNO, "1", "2", _IDA, "")
    ...
    Protected Sub btn_cancel_Click(sender As Object, e As EventArgs) Handles btn_cancel.Click
        ...
        Response.Write("window.location.href = 'FRM_DI_MAIN.aspx';")
    ...
    Private Sub BindData_PDF()
        ...
        Dim dao2 As New DAO_DRUG.ClsDBEDIT_REQUEST
        dao2.GetDataby_IDA(_IDA)

        Dim dao As New DAO_DRUG.ClsDBdrrgt
        dao.GetDataby_IDA(dao2.fields.FK_IDA)

        Dim cls_regis As New CLASS_GEN_XML.EDIT_REQUEST(_CLS.CITIZEN_ID, dao.fields.lcnsid, dao.fields.lctcd, dao.fields.IDA)

        Dim class_xml As New CLASS_EDIT_REQUEST
        class_xml = cls_regis.gen_xml_EDIT_REQUEST()

        Try
            'Dim rcvdate As Date = dao.fields.rcvdate
            'dao.fields.rcvdate = DateAdd(DateInterval.Year, 543, rcvdate)
            class_xml.EDIT_REQUESTs = dao2.fields
        Catch ex As Exception
