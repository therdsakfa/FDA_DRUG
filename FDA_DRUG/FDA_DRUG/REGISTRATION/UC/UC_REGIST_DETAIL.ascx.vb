...
Public Class UC_REGIST_DETAIL
    ...
    Sub bind_label()
        ...
        Try
            ...
            dao_dactg.GetData_by_cd(dao.fields.DRUG_GROUP)
        ...
        Try
            ...
            dao_drclass.GetDataBycd(dao.fields.GROUP_TYPE)
        ...
        Try
            ...
            dao_dose.GetDataby_cd(dao.fields.FK_DOSAGE_FORM)
        ...
        Try
            ...
            'rcb_drug_type.SelectedValue = dao.fields.kindcd
            lbl_drug_type.Text = dao_drkdofdrg.fields.thakindnm
        Catch ex As Exception
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        dao.update()
        Dim uri As String = HttpContext.Current.Request.Url.AbsoluteUri.ToString()
        Response.Write("<script type='text/javascript'>alert('บันทึกแล้วเรียบร้อย'); window.location='" & Uri & "';</script> ")
