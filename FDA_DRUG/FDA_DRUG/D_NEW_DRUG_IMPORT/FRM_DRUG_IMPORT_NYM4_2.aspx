<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCT_ID.Master" CodeBehind="FRM_DRUG_IMPORT_NYM4_2.aspx.vb" Inherits="FDA_DRUG.FRM_DRUG_IMPORT_NYM4_2" %>
    ...
    <div>
        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="true" PageSize="20" style="margin-left: 3px; margin-bottom: 10px;" Width="100%">
            <MasterTableView AutoGenerateColumns="False">
                <Columns>
                    <telerik:GridBoundColumn DataField="NYM4_COMPANY_IDA" DataType="System.Int32" FilterControlAltText="Filter NYM4_COMPANY_IDA column" HeaderText="IDA"
                        SortExpression="NYM4_COMPANY_IDA" UniqueName="NYM4_COMPANY_IDA" Display="false">
                    ...
                    <telerik:GridBoundColumn DataField="NYM4_COMPANY_DATE_TOP" FilterControlAltText="Filter NYM4_COMPANY_DATE_TOP column"
                        HeaderText="วันเวลาที่ส่งคำขอ" SortExpression="NYM4_COMPANY_DATE_TOP" UniqueName="NYM4_COMPANY_DATE_TOP">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="NYM4_COMPANY_WISH_MED" FilterControlAltText="Filter NYM4_COMPANY_WISH_MED column"
                        HeaderText="ชื่อยา (Th/Eng)" SortExpression="NYM4_COMPANY_WISH_MED" UniqueName="NYM4_COMPANY_WISH_MED">
                    </telerik:GridBoundColumn>
