<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCT_ID.Master" CodeBehind="FRM_DRUG_IMPORT_NYM5.aspx.vb" Inherits="FDA_DRUG.FRM_DRUG_IMPORT_NYM5" %>
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="true" PageSize="20" style="margin-left: 3px; margin-bottom: 10px;" Width="100%">
            <MasterTableView AutoGenerateColumns="False">
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="NYM5_WISH_MED" FilterControlAltText="Filter NYM5_WISH_MED column"
                        HeaderText="ชื่อยา (Th/Eng)" SortExpression="NYM5_WISH_MED" UniqueName="NYM5_WISH_MED">
                    </telerik:GridBoundColumn>
