...
Public Class POPUP_NYM_SUBMIT_REQUEST
    ...
    Private Sub BindData_PDF()
        ...
        Dim filename As String = paths & dao_pdftemplate.fields.PDF_OUTPUT & "\" & NAME_PDF("DA", _Process, year, _TR_ID)
        Dim Path_XML As String = paths & dao_pdftemplate.fields.XML_PATH & "\" & NAME_XML("DA", _Process, year, _TR_ID)
        'load_PDF(filename)
        ...
        _CLS.FILENAME_PDF = NAME_PDF("DA", _Process, year, _TR_ID)
