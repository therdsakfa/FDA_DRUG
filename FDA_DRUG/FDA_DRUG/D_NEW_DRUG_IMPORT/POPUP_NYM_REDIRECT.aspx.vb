Public Class POPUP_NYM_REDIRECT
    ...
    Private Sub POPUP_NYM_REDIRECT_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        'Redirect_obj()
        ' Response.Write("<script type='text/javascript'>Redirect_page();</script> ")
        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "Codeblock", "Redirect_page();", True)
    End Sub
