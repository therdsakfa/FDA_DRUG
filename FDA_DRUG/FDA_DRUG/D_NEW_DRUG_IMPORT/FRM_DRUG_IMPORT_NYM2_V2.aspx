<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCT_ID.Master" CodeBehind="FRM_DRUG_IMPORT_NYM2_V2.aspx.vb" Inherits="FDA_DRUG.FRM_DRUG_IMPORT_NYM2_V2" %>
            ...
            <MasterTableView AutoGenerateColumns="False">
                <Columns>
                    ...
                    <%--<telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_upload"
                        CommandName="upload" Text="อัพโหลดเอกสารยื่นยัน">
                        <HeaderStyle Width="70px" />
                    </telerik:GridButtonColumn>--%>
        ...
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    ระบบนำเข้ายาเฉพาะครั้ง<button type="button" class="btn btn-default pull-right" data-dismiss="modal" onclick="close_modal();">Close</button>
                </div>
