...
Public Class FRM_XML
    ...
    Protected Sub NYM2_Click(sender As Object, e As EventArgs) Handles NYM2.Click
    ...
    Protected Sub NYM3_Click(sender As Object, e As EventArgs) Handles NYM3.Click
