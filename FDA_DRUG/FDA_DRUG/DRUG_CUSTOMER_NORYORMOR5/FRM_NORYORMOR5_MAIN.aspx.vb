Public Class FRM_NORYORMOR5_MAIN
    ...
    Private Sub GV_data_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GV_data.RowCommand
        ...
        If e.CommandName = "sel" Then
            ...
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_NORYORMOR5_CONFIRM.aspx?IDA=" & str_ID & "&TR_ID=" & tr_id & "');", True)
