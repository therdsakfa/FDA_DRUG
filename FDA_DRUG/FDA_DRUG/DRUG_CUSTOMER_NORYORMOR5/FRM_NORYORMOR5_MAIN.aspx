<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NODE.Master" CodeBehind="FRM_NORYORMOR5_MAIN.aspx.vb" Inherits="FDA_DRUG.FRM_NORYORMOR5_MAIN" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ContentPlaceHolder1_btn_upload').click(function () {
                ...
                //  $('#spinner').toggle('slow');
                Popups('POPUP_NORYORMOR5_UPLOAD.aspx');
                return false;
            });
