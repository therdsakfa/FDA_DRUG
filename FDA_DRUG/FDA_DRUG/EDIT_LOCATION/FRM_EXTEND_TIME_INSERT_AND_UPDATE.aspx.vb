Public Class FRM_EXTEND_TIME_INSERT_AND_UPDATE
    ...
    End Sub
    Sub set_data(ByRef dao As DAO_DRUG.TB_LCN_EXTEND)
        dao.fields.YEAR_EXTEXD = txt_year.Text
