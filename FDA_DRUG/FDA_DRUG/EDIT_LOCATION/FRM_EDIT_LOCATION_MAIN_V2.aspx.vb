...
Public Class FRM_EDIT_LOCATION_MAIN_V2
    ...
    Private Sub GV_data_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GV_data.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            btn_Select.Attributes.Add("onclick", "Popups2('../EDIT_LOCATION/FRM_EDIT_LOCATION_INSERT_AND_UPDATE.aspx?IDA=" & ida & "'); return false;")
    ...
    Sub load_GV_lcnno()
        ...
        dt = bao_DB.SP_LCN_EDIT_REQUEST_CANCEL_BY_FK_IDA_AND_TYPE(_lct_ida, 1)
    ...
    Private Sub btn_Add_Click(sender As Object, e As EventArgs) Handles btn_Add.Click
        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('FRM_EDIT_LOCATION_INSERT_AND_UPDATE.aspx?process=" & _process & "&lct_ida=" & _lct_ida & "');", True)
    End Sub
