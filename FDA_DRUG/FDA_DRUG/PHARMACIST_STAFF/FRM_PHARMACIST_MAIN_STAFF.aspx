<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NODE.Master" CodeBehind="FRM_PHARMACIST_MAIN_STAFF.aspx.vb" Inherits="FDA_DRUG.FRM_PHARMACIST_MAIN_STAFF" %>
   ...
   <div>
    ...
    <Columns>
          <asp:TemplateField ItemStyle-Width="0%" Visible="false" >
           ...
           <asp:BoundField DataField="IDA" HeaderText="IDA" ItemStyle-Width ="0%"  />
