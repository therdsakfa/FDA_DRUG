...
Public Class FRM_LOCATION_STAFF_TO
    ...
    Private Sub RadGrid1_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        dt = bao.SP_CUSTOMER_DALCN_LOCATION_ADDRESS_LCT(2)
    ...
    Protected Sub RadGrid1_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            'H.Attributes.Add("onclick", "Popups2('" & "FRM_STAFF_LOCATION_TO_CONFIRM.aspx?IDA=" & IDA & "&TR_ID=" & TR_ID & "');")
            H.Attributes.Add("onclick", "Popups2('" & "../STAFF_LOCATION/FRM_STAFF_LOCATION_DALCN_CONFIRM.aspx?IDA=" & IDA & "');")
        End If
    End Sub
