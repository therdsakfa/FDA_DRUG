Public Class POPUP_TABEAN_YA_STAFF_CONSIDER_UPDATE
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
    End Sub
    Public Sub getdata(ByRef dao As DAO_DRUG.ClsDBdrrgt)
        Try
    ...
    End Sub
    Public Sub set_data(ByRef dao As DAO_DRUG.ClsDBdrrgt)
