<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NODE.Master" CodeBehind="FRM_NORYORMOR4_MAIN.aspx.vb" Inherits="FDA_DRUG.FRM_NORYORMOR4_MAIN" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ContentPlaceHolder1_btn_upload').click(function () {
                ...
                //  $('#spinner').toggle('slow');
                Popups('POPUP_NORYORMOR4_UPLOAD.aspx');
                return false;
            });
