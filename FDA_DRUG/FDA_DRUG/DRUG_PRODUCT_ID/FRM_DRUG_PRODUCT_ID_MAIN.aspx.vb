Public Class FRM_DRUG_PRODUCT_ID_MAIN
    ...
    Private Sub GV_lcnno_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GV_lcnno.RowCommand
        ...
        ElseIf e.CommandName = "del" Then
            ...
            dao.GetDataby_IDA(str_ID)
            dao.fields.ACTIVE = 0
            dao.fields.NON_ACTIVE_DATE = Date.Now
            dao.update()
            load_GV_lcnno()
        ElseIf e.CommandName = "accept" Then
            If Chk_Input_Section2(str_ID) <> "" Then
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('ไม่สามารถส่งเรื่องได้เนื่องจากยังไม่ได้กรอกข้อมูล \n" & Chk_Input_Section2(str_ID) & "');", True)
            Else
            ...
            End If
    End Sub
    Function Chk_Input_Section2(ByVal ida As String) As String
        Dim str As String = ""
        ...
        bool1 = dao.Count_input(ida)
        bool2 = dao2.Count_input(ida)
        If bool1 = False Then
    ...
    Private Sub GV_lcnno_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GV_lcnno.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim id As String = ""
            Try
                id = GV_lcnno.DataKeys.Item(e.Row.RowIndex).Value.ToString()
            Catch ex As Exception
