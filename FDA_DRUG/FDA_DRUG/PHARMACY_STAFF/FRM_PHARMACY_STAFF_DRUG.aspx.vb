Public Class FRM_PHARMACY_STAFF_DRUG
...
#Region "GRIDVIEW"
    ...
    Protected Sub GV_lcnno_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GV_lcnno.RowCommand
        ...
        If e.CommandName = "sel" Then
            ...
            End Try
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "FRM_PHARMACY_CONFIRM_DRUG_STAFF.aspx?IDA=" & str_ID & "&TR_ID=" & tr_id & "');", True)
