Public Class POPUP_STAFF_EXTEND_TIME_LOCATION_REMARK
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            dao.fields.CANCEL_DATE = txt_app_date.Text
    ...
    Sub alert_reload(ByVal text As String)
        ...
        Response.Redirect("FRM_STAFF_LOCATION_CONFIRM.aspx?IDA=" & _IDA & "&TR_ID=" & _TR_ID & "&process=" & _Process)
