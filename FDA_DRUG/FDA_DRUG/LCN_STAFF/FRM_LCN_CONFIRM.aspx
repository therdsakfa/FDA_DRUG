<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_LCN_CONFIRM.aspx.vb" Inherits="FDA_DRUG.WebForm35" %>
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <%--     <tr>
                     ...
                     <tr><td> <asp:Button ID="btn_cancel" runat="server" Text="ยกเลิกคำขอ" CssClass="btn-lg"   Width="80%"/></td></tr>
                     ...
                     <tr><td>  <asp:Button ID="btn_load0" runat="server" Text="ปิดหน้านี้(กลับหน้ารายการ)" CssClass="btn-lg"   Width="80%" /></td></tr>
