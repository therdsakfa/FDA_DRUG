Public Class FRM_RGT_EDIT_CHECK_RQT_SSP
    ...
    Public Sub Set_rcvno_txt()
        ...
        'End Try
        txt_rcvno.Text = CStr(running) & "/" & _year2
    End Sub
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        If CHK_FORMAT_RCVNO(txt_rcvno.Text) = True Then
            Dim dao_rqt As New DAO_DRUG.TB_DRRGT_EDIT_REQUEST
            dao_rqt.GetDatabyIDA(_IDA)
            Dim bao As New BAO.GenNumber 'test
            Dim RCVNO As Integer

            RCVNO = GET_FORMAT_RCVNO(txt_rcvno.Text)

            Dim i As Integer = 0
            Dim dao_chk_rcvno As New DAO_DRUG.TB_DRRGT_EDIT_REQUEST
            i = dao_chk_rcvno.GetDatabyrcvno(RCVNO)
            If i = 0 Then
