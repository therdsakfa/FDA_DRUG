<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_STAFF_NYM_SUBMIT_REQUEST.aspx.vb" Inherits="FDA_DRUG.FRM_STAFF_NYM_SUBMIT_REQUEST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <img src="../imgs/spinner.gif" alt="Loading" style="position: absolute; top: 120px; left: 293px; height: 185px; width: 207px;" />
    ...
    <table style="width: 100%; height: 500px;">      <%--สร้างพื้นที่ --%>
        <tr>
            <td rowspan="2" style="width: 70%;">     <%--สร้างพื้นที่ PDF--%>
