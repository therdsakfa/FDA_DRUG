            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <%--     <tr>
                     ...
                     <tr><td> <asp:Button ID="btn_cancel" runat="server" Text="ยกเลิก/ยกเลิกคำขอ" CssClass="btn-lg"   Width="80%" OnClientClick="return confirm('คุณต้องการบันทึกข้อมูลหรือไม่');"/></td></tr>
