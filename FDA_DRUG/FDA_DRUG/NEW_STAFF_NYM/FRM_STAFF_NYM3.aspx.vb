    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand    'กดปุ่มใน grid ให้ทำอะไร จากหหน้
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "sel" Then
                ...
                End Try
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "../NEW_STAFF_NYM/FRM_STAFFNYM_CONFIRM.aspx?IDA=" & NYM3_ida & "&Process=" & _process & "&DL=" & _DL & "&TR_ID=" & dao.fields.TR_ID & "');", True)
            ElseIf e.CommandName = "_edit" Then
                ...
                End Try
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "../NEW_STAFF_NYM/FRM_STAFF_NYM_CONSIDER_NEW.aspx?IDA=" & NYM3_ida & "&process=" & _process & "&DL=" & _DL & " &edit=" & 0 & "&TR_ID=" & dao.fields.TR_ID & "');", True)
