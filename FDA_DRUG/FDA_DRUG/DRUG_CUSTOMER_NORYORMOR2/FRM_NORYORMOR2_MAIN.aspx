<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NODE.Master" CodeBehind="FRM_NORYORMOR2_MAIN.aspx.vb" Inherits="FDA_DRUG.FRM_NORYORMOR2_MAIN" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ContentPlaceHolder1_btn_upload').click(function () {
                ...
                //  $('#spinner').toggle('slow');
                Popups('POPUP_NORYORMOR2_UPLOAD.aspx');
                return false;
            });
