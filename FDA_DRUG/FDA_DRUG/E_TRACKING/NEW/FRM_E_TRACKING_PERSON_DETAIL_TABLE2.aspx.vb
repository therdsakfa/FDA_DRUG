Public Class FRM_E_TRACKING_PERSON_DETAIL_TABLE2
    ...
    Private Sub btn_back_Click(sender As Object, e As EventArgs) Handles btn_back.Click
        If Request.QueryString("p") = "" Then
            Response.Redirect("../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH2.aspx?gid=" & Request.QueryString("gid") & "&g=" & Request.QueryString("g") & "&iden=" & Request.QueryString("iden") & "&p=1")
        Else
            Response.Redirect("../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON.aspx?gid=" & Request.QueryString("gid") & "&g=" & Request.QueryString("g") & "&iden=" & Request.QueryString("iden"))
        End If
    End Sub
End Class