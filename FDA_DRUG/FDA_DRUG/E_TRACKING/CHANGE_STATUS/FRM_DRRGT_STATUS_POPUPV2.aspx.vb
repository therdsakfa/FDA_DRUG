Public Class FRM_DRRGT_STATUS_POPUPV2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            UC_INFORMATION_HEAD_V21.set_label()
    ...
    Private Sub btn_confirm_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        ...
        Try
            ...
            dao_current.GetDataby_rcvno_rgttpcd_b_type_sub_type_v2(Request.QueryString("rcvno"), Request.QueryString("ntype"), Request.QueryString("b_type"), Request.QueryString("s_type"), Request.QueryString("drgtpcd"))
            ...
            '    Try
            '        have_expert = dao_ex.GetDataby_rcvno_ctzid_rgttpcd(Request.QueryString("rcvno"), Request.QueryString("ctzid"), Request.QueryString("ntype"))
            '    Catch ex As Exception
            ...
            'Dim bool As Boolean = False
            'Dim dao_count As New DAO_DRUG.TB_E_TRACKING_CURRENT_STATUS
            'bool = dao_count.count_idV3(Request.QueryString("rcvno"), Request.QueryString("ntype"), Request.QueryString("b_type"), Request.QueryString("s_type"))
            'If bool = True Then
            '    dao_count = New DAO_DRUG.TB_E_TRACKING_CURRENT_STATUS
            '    dao_count.GetDataby_rcvno_rgttpcd_b_type_sub_type(Request.QueryString("rcvno"), Request.QueryString("ntype"), Request.QueryString("b_type"), Request.QueryString("s_type"))
            '    dao_count.fields.STATUS_ID = ddl_cnsdcd.SelectedValue
            '    Try
            '        dao_count.fields.STATUS_DATE = CDate(txt_stat_date.Text)
            '    Catch ex As Exception
            ...
            dao_max.GetDataby_GEN4(Request.QueryString("rcvno"), Request.QueryString("ntype"), Request.QueryString("b_type"), Request.QueryString("s_type"), Request.QueryString("drgtpcd"))
    ...
    Public Sub Bind_ddl_Status_staff()
        ...
        dao_g.GetDataby_HEAD_ID(Request.QueryString("head"))
    ...
    Private Sub btn_back_Click(sender As Object, e As EventArgs) Handles btn_back.Click
        ...
        If Request.QueryString("extra") = "" Then
            url2 = "../CHANGE_STATUS/NEW/FRM_ETRACKING_STATUS_HEAD_MAIN.aspx?rcvno=" & Request.QueryString("rcvno") & "&ntype=" & Request.QueryString("ntype") & "&new=1&b_type=" & Request.QueryString("b_type") & "&s_type=" & Request.QueryString("s_type") & "&drgtpcd=" & Request.QueryString("drgtpcd")
        Else
            url2 = "../CHANGE_STATUS/NEW/FRM_ETRACKING_STATUS_SUB_MAIN.aspx?rcvno=" & Request.QueryString("rcvno") & "&ntype=" & Request.QueryString("ntype") & "&new=1&b_type=" & Request.QueryString("b_type") & "&s_type=" & Request.QueryString("s_type") & "&extra=1" & "&drgtpcd=" & Request.QueryString("drgtpcd")
        End If
