...
#Region "GRIDVIEW"
    ...
    Protected Sub GV_lcnno_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GV_lcnno.RowCommand
        ...
        ElseIf e.CommandName = "_attach" Then
            ...
            Response.Write("<script>window.open ('../EXTEND_TIME_LOCATION/FRM_EXTEND_LCN_ATTACH_PAGE.aspx?TR_ID=" & tr_id & "&process=" & dao.fields.PROCESS_ID & "&IDA=" & str_ID & "&r_ida=" & dao.fields.FK_IDA & "','_blank');</script>")
