<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_PHARMACY_CONFIRM_DRUG.aspx.vb" Inherits="FDA_DRUG.FRM_LCN_CONFIRM_DRUG" %>
   ...
   <script type="text/javascript" >
       $(document).ready(function () {
           ...
           $('#ContentPlaceHolder1_btn_upload').click(function () {
               ...
               $('#spinner').toggle('slow');
               Popups('POPUP_PHARMACY_UPLOAD.aspx');
               return false;
           });

           $('#ContentPlaceHolder1_btn_download').click(function () {
               $('#spinner').fadeIn('slow');
               Popups('POPUP_PHARMACY_DOWNLOAD.aspx');
               return false;
           });
