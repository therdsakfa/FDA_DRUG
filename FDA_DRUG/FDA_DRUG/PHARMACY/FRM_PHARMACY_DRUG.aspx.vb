...
Public Class FRM_PHARMACY_DRUG
...
#Region "GRIDVIEW"
    ...
    Protected Sub GV_lcnno_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GV_lcnno.RowCommand
        ...
        If e.CommandName = "sel" Then
            ...
            End Try
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "FRM_PHARMACY_CONFIRM_DRUG.aspx?IDA=" & str_ID & "&TR_ID=" & tr_id & "&process=" & _process & "');", True)
...
#End Region
    ...
    Protected Sub btn_upload_Click(sender As Object, e As EventArgs) Handles btn_upload.Click
        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_PARMACY_UPLOAD_ATTACH.aspx?type_id=" & _process & "&process=" & _process & "');", True)
