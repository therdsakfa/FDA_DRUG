Public Class DRUG_REQUEST_CENTER_INSERT_CUSTOMER
    ...
    Sub ddl_type_req()
        ...
        dt = bao.SP_TYPE_REQUESTS_CUSTOMER()
        'Dim dao As New DAO_DRUG.TB_MAS_TYPE_REQUESTS
        'dao.GetDataAll_active_for_Customer()
    ...
    Sub Run_Data_Onload()
        ...
        If ctz <> "" Then
            Dim txt As String = ""
            txt = set_name_company(_CLS.CITIZEN_ID)
            lbl_request_name.Text = txt


            Dim txt2 As String = ""
            txt2 = set_name_company(ctz)
            lbl_company.Text = txt2



            Dim dt As New DataTable
            Dim bao As New BAO.ClsDBSqlcommand
            dt = bao.SP_LOCATION_ADDRESS_BY_IDENTIFY(ctz)
    ...
    Public Sub set_data(ByRef dao As DAO_DRUG.TB_DRUG_REQUEST_CENTER)
        ...
        dao.fields.CITIZEN_AUTHIRIZE = _CLS.CITIZEN_ID_AUTHORIZE
    ...
    Function Count_Null() As Integer
        ...
        If Len(txt_nameplace_key.Text) = 0 Then
            null_no += 1
        End If
        If Len(txt_fulladdr.Text) = 0 Then
            null_no += 1
        End If
        Return null_no
    End Function
    Private Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        If IsNothing(_CLS.CITIZEN_ID_AUTHORIZE) Then
