Public Class DRUG_REQUEST_CENTER_C_INSERT_MANUAL
            ...
            If count_c <= 1 Then
                If ddl_placename.Items.Count = 0 Then
                    If Count_Null() = 0 Then
                        ...
                        dao.fields.RCVNO_DISPLAY = txt_c_no.Text
                        ...
                        Dim str As String() = txt_c_no.Text.Split("-")
                        Dim dao_rcv As New DAO_DRUG.TB_GEN_RCVNO_REQUEST
                        dao_rcv.fields.YEARS = con_year(Date.Now.Year)
                        dao_rcv.fields.PVNCD = _CLS.PVCODE
                        dao_rcv.fields.PROCESS_ID = PROCESS_ID
                        dao_rcv.fields.FK_IDA = ida
                        Try
                            dao_rcv.fields.GEN_RCV = str(3)
                        Catch ex As Exception

                        End Try

                        dao_rcv.fields.GEN_TYPE = 2
                        dao_rcv.insert()
                ...
                Else
                    ...
                    'rcvno = bao.GEN_RCVNO_REQUEST(con_year(Date.Now.Year), _CLS.PVCODE, "2", txt_lcnno.Text, "", ddl_category_requests.SelectedValue, ida, ddl_category_requests.SelectedItem.Text)
                    dao.fields.RCVNO = rcvno
                    dao.fields.RCVNO_DISPLAY = txt_c_no.Text 'rcvno & "-C"
                    dao.fields.REQUEST_CENTER_TYPE = 2
                    Try
                        dao.fields.HEAD_IDA = HiddenField1.Value
                    Catch ex As Exception
