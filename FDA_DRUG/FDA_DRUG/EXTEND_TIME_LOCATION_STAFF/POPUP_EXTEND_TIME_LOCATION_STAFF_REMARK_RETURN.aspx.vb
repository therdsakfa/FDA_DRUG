Public Class POPUP_EXTEND_TIME_LOCATION_STAFF_REMARK_RETURN
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            AddLogStatus(5, dao.fields.PROCESS_ID, _CLS.CITIZEN_ID, _IDA)
            dao.fields.SALE_MEDICIAN2 = _CLS.CITIZEN_ID
            dao.fields.SALE_MEDICIAN1 = Txt_Remark.Text
            dao.update()
