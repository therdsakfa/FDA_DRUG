...
Public Class FRM_CHEMICAL_HERB_MAIN
    ...
    Sub load_GV_data()                                                          ' Gridview นำมาโชว์
        ...
        GV_data.DataSource = bao.SP_CHEMICAL_REQUEST_CUSTOMER_HERB(_CLS.CITIZEN_ID_AUTHORIZE, _mt, g)   'นำข้อมูลมโชในจาก SP มาไว้ที่ DataTable
    ...
    Private Sub GV_data_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GV_data.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim url As String = ""
            url = "../CHEMICAL/POPUP_BIO_INSERT_AND_UPDATE.aspx?ida=" & ida & "&g=" & Request.QueryString("g") & _
                "&mt=" & Request.QueryString("mt") & "&process=" & Request.QueryString("process")
            ' btn_edit.Attributes.Add("onclick", "Popups2('../CHEMICAL/POPUP_HERB_INSERT_AND_UPDATE.aspx?IDA=" & ida & "'); return false;")
