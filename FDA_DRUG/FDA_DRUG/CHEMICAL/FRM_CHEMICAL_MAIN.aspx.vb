...
Public Class FRM_CHEMICAL_MAIN
    ...
    Sub load_GV_data()                                                          ' Gridview นำมาโชว์
        ...
        GV_data.DataSource = bao.SP_CHEMICAL_REQUEST_CUSTOMER_CHEM_TYPE(_CLS.CITIZEN_ID_AUTHORIZE, _mt, _st, _t)
    ...
    Private Sub convert_Database_To_XML(ByVal path As String)
        ...
        cls_xml.DT_SHOW.DT4 = bao_show.SP_MAINPERSON_CTZNO(_CLS.CITIZEN_ID_AUTHORIZE)
        'cls_xml.DT_SHOW.DT4 = bao_show.SP_SYSLCNSNM_BY_LCNSID_AND_IDENTIFY(_CLS.CITIZEN_ID_AUTHORIZE, _CLS.LCNSID_CUSTOMER)
    ...
    Private Sub GV_data_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GV_data.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim btn_remark As Button = DirectCast(e.Row.FindControl("btn_remark"), Button)
            ...
            btn_remark.Attributes.Add("onclick", "Popups3('../CHEMICAL/FRM_CHEMICAL_REMARK.aspx?IDA=" & ida & "'); return false;")
